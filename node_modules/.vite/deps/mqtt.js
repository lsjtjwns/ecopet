...
function ew() {
	!Qr || !wr || (Qr = !1, wr.length ? Mt = wr.concat(Mt) : Pi = -1, Mt.length && ac());
}
function ac() {
	if (!Qr) {
...
var Af = ze(() => {
	...
	cc = "browser", fc = "x64", hc = "browser", dc = {
		PATH: "/usr/bin",
		LANG: typeof navigator < "u" ? navigator.language + ".UTF-8" : void 0,
		PWD: "/",
		HOME: "/home",
		TMP: "/tmp"
	}, pc = ["/usr/bin/node"], yc = [], gc = "v16.8.0", bc = {}, wc = function(t, e) {
		console.warn((e ? e + ": " : "") + t);
	}, mc = function(t) {
		cs("binding");
	}, _c = function(t) {
	...
	zc = Ue, Kc = Ue, Qc = Ue, Yc = Ue, Jc = Ue, Xc = void 0, Zc = void 0, ef = void 0, tf = Ue, rf = 2, nf = 1, of = "/bin/usr/node", sf = 9229, af = "node", uf = [], lf = Ue, Jt = {
...
function tw() {
	if (If) return On;
	If = !0, On.byteLength = a, On.toByteArray = f, On.fromByteArray = m;
...
function Pf() {
	...
	function i() {
		try {
			let p = /* @__PURE__ */ new Uint8Array(1), u = { foo: function() {
				return 42;
			} };
...
var Xr = j((jO, Kf) => {
	...
	var em = et((t, e, r) => {
		if (!Wf(r, t)) throw new Jr(e, t, "must be one of: " + $f(Bw(r, (s) => typeof s == "string" ? `'${s}'` : Dw(s)), ", "));
	});
	function Gf(t, e) {
...
var tr = j((YO, Xf) => {
	...
	var qt = [], Zr = !1, Sr, Li = -1;
	function bm() {
		!Zr || !Sr || (Zr = !1, Sr.length ? qt = Sr.concat(qt) : Li = -1, qt.length && Yf());
	}
	function Yf() {
		if (!Zr) {
			var t = Qf(bm);
...
var mt = j((sR, dh) => {
	...
	function Sm(t, e) {
		return t == null ? !1 : e === !0 ? typeof t[Zf] == "function" : e === !1 ? typeof t[eh] == "function" : typeof t[Zf] == "function" || typeof t[eh] == "function";
	}
	function ji(t) {
		if (!wt(t)) return null;
	...
	function lh(t) {
		return t && t[Ss] != null ? t[Ss] : typeof t?.readable != "boolean" ? null : ji(t) ? !1 : Ui(t) && t.readable && !uh(t);
	}
	function ch(t) {
		return t && t[Es] != null ? t[Es] : typeof t?.writable != "boolean" ? null : ji(t) ? !1 : Di(t) && t.writable && !ah(t);
	}
	function Im(t, e) {
		return wt(t) ? ji(t) ? !0 : !(e?.readable !== !1 && lh(t) || e?.writable !== !1 && ch(t)) : null;
	}
	function xm(t) {
		var e, r;
	...
	function Rm(t) {
		if (!wt(t)) return null;
		let e = t._writableState, r = t._readableState, n = e || r;
		return !n && hh(t) || !!(n && n.autoDestroy && n.emitClose && n.closed === !1);
	}
	function km(t) {
		var e;
...
var Ut = j((gR, Ps) => {
	...
	function Ah(t, e, r) {
		...
		let s = (n = e.readable) !== null && n !== void 0 ? n : As(t), o = (i = e.writable) !== null && i !== void 0 ? i : mh(t), a = t._writableState, c = t._readableState, f = () => {
			t.writable || m();
		}, h = Vm(t) && As(t) === s && mh(t) === o, d = _h(t, !1), m = () => {
...
var Ar = j((xR, Ch) => {
	...
	function n_(t, e) {
		...
		return n != null && n.destroyed || r != null && r.destroyed ? (typeof e == "function" && e(), this) : (Oh(t, n, r), n && (n.destroyed = !0), r && (r.destroyed = !0), i.constructed ? Ih(this, t, e) : this.once(Ph, function(s) {
			Ih(this, Ym(s, t), e);
		}), this);
	}
	function Ih(t, e, r) {
		...
		function i(s) {
			...
			Oh(s, a, o), a && (a.closed = !0), o && (o.closed = !0), typeof r == "function" && r(s), s ? _t.nextTick(i_, t, s) : _t.nextTick(Rh, t);
		}
		try {
			t._destroy(e || null, i);
		} catch (s) {
	...
	function a_(t) {
		...
		function r(n) {
			...
			i && (i.constructed = !0), s && (s.constructed = !0), o.destroyed ? t.emit(Ph, n) : n ? ks(t, n, !0) : _t.nextTick(u_, t);
		}
		try {
			t._construct((n) => {
				_t.nextTick(r, n);
	...
	function c_(t, e) {
		!t || e_(t) || (!e && !t_(t) && (e = new Xm()), r_(t) ? (t.socket = null, t.destroy(e)) : xh(t) ? t.abort() : xh(t.req) ? t.req.abort() : typeof t.destroy == "function" ? t.destroy(e) : typeof t.close == "function" ? t.close() : e ? _t.nextTick(l_, t, e) : _t.nextTick(kh, t), t.destroyed || (t[Zm] = !0));
	}
	Ch.exports = {
		construct: s_,
		destroyer: c_,
...
var kn = j((GR, Hi) => {
	...
	Hi.exports.addAbortSignal = function(e, r) {
		if (b_(e, "signal"), !qh(r) && !p_(r)) throw new Lh("stream", [
			"ReadableStream",
			"WritableStream",
			"Stream"
		], r);
...
var Nn = j((Xk, wd) => {
	...
	nd(le, nr);
	var js = () => {}, { errorOrDestroy: tn } = nn, rn = 1, yv = 2, ad = 4, Mn = 8, ud = 16, zi = 32, Ki = 64, ld = 128, gv = 256, bv = 512, wv = 1024, Hs = 2048, Vs = 4096, mv = 8192, _v = 16384, vv = 32768, cd = 65536, Sv = 1 << 17, Ev = 1 << 18;
	function Ce(t) {
		return {
			enumerable: !1,
			get() {
	...
	function Fs(t, e, r, n) {
		e.flowing && e.length === 0 && !e.sync && t.listenerCount("data") > 0 ? ((e.state & cd) !== 0 ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null, e.dataEmitted = !0, t.emit("data", r)) : (e.length += e.objectMode ? 1 : r.length, n ? e.buffer.unshift(r) : e.buffer.push(r), (e.state & Ki) !== 0 && Ji(t)), Qi(t, e);
	}
	...
	le.prototype.read = function(t) {
		...
		let i;
		return t > 0 ? i = gd(t, e) : i = null, i === null ? (e.needReadable = e.length <= e.highWaterMark, t = 0) : (e.length -= t, e.multiAwaitDrain ? e.awaitDrainWriters.clear() : e.awaitDrainWriters = null), e.length === 0 && (e.ended || (e.needReadable = !0), r !== t && e.ended && Ws(this)), i !== null && !e.errorEmitted && !e.closeEmitted && (e.dataEmitted = !0, this.emit("data", i)), i;
	};
	function xv(t, e) {
		if (de("onEofChunk"), !e.ended) {
			...
			e.ended = !0, e.sync ? Ji(t) : (e.needReadable = !1, e.emittedReadable = !0, hd(t));
		}
	}
	function Ji(t) {
		let e = t._readableState;
		de("emitReadable", e.needReadable, e.emittedReadable), e.needReadable = !1, e.emittedReadable || (de("emitReadable", e.flowing), e.emittedReadable = !0, lt.nextTick(hd, t));
	}
	function hd(t) {
		let e = t._readableState;
		de("emitReadable_", e.destroyed, e.length, e.ended), !e.destroyed && !e.errored && (e.length || e.ended) && (t.emit("readable"), e.emittedReadable = !1), e.needReadable = !e.flowing && !e.ended && e.length <= e.highWaterMark, pd(t);
	}
	function Qi(t, e) {
	...
	function kv(t, e) {
		de("resume", e.reading), e.reading || t.read(0), e.resumeScheduled = !1, t.emit("resume"), pd(t), e.flowing && !e.reading && t.read(0);
	}
...
var ro = j((uC, Rd) => {
	...
	Ed(Ie, Dv, {
		__proto__: null,
		value: function(t) {
			return Sd(this, t) ? !0 : this !== Ie ? !1 : t && t._writableState instanceof Un;
		}
	});
	...
	function Jv(t, e) {
		...
		r.writing = !1, r.writecb = null, r.length -= r.writelen, r.writelen = 0, e ? (e.stack, r.errored || (r.errored = e), t._readableState && !t._readableState.errored && (t._readableState.errored = e), n ? Tr.nextTick(_d, t, r, e, i) : _d(t, r, e, i)) : (r.buffered.length > r.bufferedIndex && Js(t, r), n ? r.afterWriteTickInfo !== null && r.afterWriteTickInfo.cb === i ? r.afterWriteTickInfo.count++ : (r.afterWriteTickInfo = {
			...
			stream: t,
			state: r
		}, Tr.nextTick(Xv, r.afterWriteTickInfo)) : Pd(t, r, 1, i));
	}
	...
	function Js(t, e) {
		...
		if (e.bufferProcessing = !0, s > 1 && t._writev) {
			...
			c.allBuffers = e.allBuffers, md(t, e, !0, e.length, c, "", a), eo(e);
		} else {
			do {
				let { chunk: a, encoding: c, callback: f } = r[o];
				r[o++] = null;
				md(t, e, !1, i ? 1 : a.length, a, c, f);
...
var Vd = j((wC, Hd) => {
	...
	Hd.exports = function t(e, r) {
		...
		if (kd(e)) return Dd(ir, e, {
			objectMode: !0,
			writable: !1
		});
		if (Md(e?.readable) && Nd(e?.writable)) return ir.fromWeb(e);
		if (typeof e?.writable == "object" || typeof e?.readable == "object") return an({
			readable: e != null && e.readable ? Cd(e?.readable) ? e?.readable : t(e.readable) : void 0,
			writable: e != null && e.writable ? Bd(e?.writable) ? e?.writable : t(e.writable) : void 0
		});
		let n = e?.then;
...
var Bp = j((_M, Cp) => {
	...
	we._init = function(e) {
		Object.defineProperty(this, kp, { value: !0 }), this._bufs = [], this.length = 0, e && this.append(e);
	};
...
var Hp = j((N2, $p) => {
	...
	x();
	I();
	var GS = Mp(), { EventEmitter: zS } = (er(), me(Zt)), Wp = qp(), pe = Pa(), ae = At()("mqtt-packet:parser");
	$p.exports = class t extends zS {
		constructor() {
		...
		_newPacket() {
			return ae("_newPacket"), this.packet && (this._list.consume(this.packet.length), ae("_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d", this.packet.cmd, this.packet.payload, this.packet.length), this.emit("packet", this.packet)), ae("_newPacket: new packet"), this.packet = new Wp(), this._pos = 0, !0;
		}
		_emitError(e) {
...
var Ba = j((fN, ny) => {
	...
	x();
	I();
	var ue = Pa(), { Buffer: se } = (ke(), me(qe)), eE = se.allocUnsafe(0), tE = se.from([0]), Vn = Kp(), rE = Qp().nextTick, rt = At()("mqtt-packet:writeToStream"), yo = Vn.cache, nE = Vn.generateNumber, iE = Vn.generateCache, ka = Vn.genBufVariableByteInt, oE = Vn.generate4ByteBuffer, He = Ca, go = !0;
	function ty(t, e, r) {
	...
	function aE(t, e, r) {
		...
		let b = !1;
		if (h != null) if (ey(h)) b = !0, g += se.byteLength(h) + 2;
		...
		switch (t.log("handlePublish: qos %d", s), s) {
			case 2:
				a.customHandleAcks(n, i, e, (c, f) => {
					...
					if (dy.indexOf(f) === -1) return t.emit("error", /* @__PURE__ */ new Error("Wrong reason code for pubrec"));
					f ? t._sendPacket({
						cmd: "pubrec",
						messageId: o,
						reasonCode: f
			...
			case 1:
				a.customHandleAcks(n, i, e, (c, f) => {
					if (typeof c == "number" && (f = c, c = null), c) return t.emit("error", c);
					if (dy.indexOf(f) === -1) return t.emit("error", /* @__PURE__ */ new Error("Wrong reason code for puback"));
...
var Ey = j((_o) => {
	...
	if (typeof mo > "u") {
		...
		let t = $a.env?.LRU_CACHE_IGNORE_AC_WARNING !== "1", e = () => {
			t && (t = !1, vy("AbortController is not defined. If using lru-cache in node 14, load an AbortController polyfill from the `node-abort-controller` package. A minimal polyfill is provided for use by LRUCache.fetch(), but it should not be relied upon in other contexts (eg, passing it to other APIs that use AbortController/AbortSignal might have undesirable effects). You may disable this with LRU_CACHE_IGNORE_AC_WARNING=1 in the env.", "NO_ABORT_CONTROLLER", "ENOTSUP", e));
		};
	}
	var NE = (t) => !_y.has(t), lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), Sy = (t) => lr(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? bn : null : null, bn = class extends Array {
		constructor(e) {
			super(e), this.fill(0);
		}
	}, Ha = class t {
...
var su = j((Bo) => {
	...
	var ky = Ry(), i1 = It(), Cy = xt(), ou = class extends i1.Container {
		...
		updateKeyByIterator(e, r) {
			let n = e.o;
			if (n === this.h && (0, Cy.throwIteratorAccessError)(), this.i === 1) return n.u = r, !0;
...
var Cu = j((AW, Ht) => {
	...
	Ht.exports = hg, Ht.exports.__esModule = !0, Ht.exports.default = Ht.exports;
});
var Nu = j((MW, ci) => {
	A();
	x();
...
var vg = j((Ho, _g) => {
	...
	I();
	(function(t, e) {
		typeof Ho == "object" && typeof _g < "u" ? e(Ho, Pu(), rg(), lg(), fg(), mg()) : typeof define == "function" && define.amd ? define([
			"exports",
			"fast-unique-numbers",
...
var Eg = j((Vo, Sg) => {
	...
	I();
	(function(t, e) {
		typeof Vo == "object" && typeof Sg < "u" ? e(Vo, vg(), Pu(), Xn()) : typeof define == "function" && define.amd ? define([
			"exports",
			"broker-factory",
			"fast-unique-numbers",
		...
		}, c = /* @__PURE__ */ new Map([[0, null]]), f = /* @__PURE__ */ new Map([[0, null]]), h = i(c), d = s(f), m = o(r.generateUniqueNumber, c), g = a(r.generateUniqueNumber, f), P = e.createBroker({
...
var kg = j((Gt) => {
	...
	var Pg = Ig(), Uu = LA(yi()), Og = {
		set: Pg.setInterval,
		clear: Pg.clearInterval
	}, Rg = {
		set: (t, e) => setInterval(t, e),
		clear: (t) => clearInterval(t)
	}, UA = (t) => {
		switch (t) {
			case "native": return Rg;
			case "worker": return Og;
			default: return Uu.default && !Uu.isWebWorker && !Uu.isReactNativeBrowser ? Og : Rg;
		}
	};
	Gt.default = UA;
});
...
var zo = j((yt) => {
	...
	var FA = yt && yt.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), qg = yt && yt.__importStar || (function() {
		var t = function(e) {
			return t = Object.getOwnPropertyNames || function(r) {
				var n = [];
				for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
...
function JA() {
	...
	let T = (H) => String.fromCodePoint(...H), y = function(H) {
		...
		let ee = 0;
		for (H = J ? P(H / s) : H >> 1, H += P(H / z); H > 455; ee += e) H = P(H / g);
		return P(ee + 36 * H / (H + i));
	}, M = function(H) {
...
function hI() {
	!En || !$r || (En = !1, $r.length ? zt = $r.concat(zt) : Ko = -1, zt.length && fb());
}
function fb() {
	if (!En) {
...
function Px() {
	...
	Al = function k(B, re, ie, oe) {
		...
		if (!he(B) && !be(B)) {
			var is = $(B, ut), ic = G ? G(B) === Object.prototype : B instanceof Object || B.constructor === Object, os = B instanceof Object ? "" : "null prototype", oc = !ic && J && Object(B) === B && J in B ? _.call(Ne(B), 8, -1) : os ? "Object" : "", ss = (ic || typeof B.constructor != "function" ? "" : B.constructor.name ? B.constructor.name + " " : "") + (oc || os ? "[" + M.call(v.call([], oc || [], os || []), ": ") + "] " : "");
...
function Ox() {
	if (gb) return xl;
	gb = !0;
	var t = Wr(), e = lb(), r = Px(), n = Sn(), i = t("%WeakMap%", !0), s = t("%Map%", !0), o = e("WeakMap.prototype.get", !0), a = e("WeakMap.prototype.set", !0), c = e("WeakMap.prototype.has", !0), f = e("Map.prototype.get", !0), h = e("Map.prototype.set", !0), d = e("Map.prototype.has", !0), m = function(b, w) {
...
function Rx() {
	if (mb) return Ol;
	mb = !0;
	var t = Ox(), e = Eb(), r = Bl(), n = Object.prototype.hasOwnProperty, i = {
		brackets: function(b) {
			return b + "[]";
		},
		comma: "comma",
...
function kx() {
	if (_b) return Rl;
	_b = !0;
	var t = Eb(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = {
		allowDots: !1,
		allowEmptyArrays: !1,
		allowPrototypes: !1,
		allowSparse: !1,
...
var Tb = ze(() => {
	...
	pb();
	vl();
	Tx = Object.freeze(Object.create(null)), Al = {}, yb = !1, Il = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : global;
	xl = {}, gb = !1;
	Tl = {}, bb = !1;
	Pl = {}, wb = !1;
	Ol = {}, mb = !1;
...
var Qo = j((mi) => {
	...
	var Ml = class extends Zx.Duplex {
		...
		writeQueue;
		constructor(e, r, n) {
			super({ objectMode: !0 }), this.proxy = r, this.socket = n, this.writeQueue = [], e.objectMode || (this._writev = kb.bind(this)), this.isSocketOpen = !1, this.proxy.on("data", (i) => {
...
var _i = j((gr) => {
	...
	var Yo = (ke(), me(qe)), Cb = ql(Ob()), eT = ql(At()), tT = or(), rT = ql(yi()), Nl = Qo(), yr = (0, eT.default)("mqttjs:ws"), nT = [
		"rejectUnauthorized",
		"ca",
		"cert",
		"key",
...
var $l = j((Si) => {
	...
	var vT = (t, e) => {
		e.port = e.port || 8883, e.host = e.hostname || e.host || "localhost", gT.default.isIP(e.host) === 0 && !e.servername && (e.servername = e.host), e.rejectUnauthorized = e.rejectUnauthorized !== !1, delete e.path, mT("port %d host %s rejectUnauthorized %b", e.port, e.host, e.rejectUnauthorized);
		let r = _T(e);
		r.on("secureConnect", () => {
...
var Ql = j((Kl) => {
	...
	var zl = (ke(), me(qe)), OT = or(), RT = Qo(), Kt, Ei, An, jb = !1;
	function kT() {
...
var $b = j((In) => {
	...
	function Wb(t, e) {
		if (Fb("connecting to an MQTT broker..."), typeof t == "object" && !e && (e = t, t = ""), e = e || {}, t && typeof t == "string") {
			let i = LT.default.parse(t, !0), s = {}, o = !i.protocol && !i.hostname && i.path?.startsWith("/") && (Yl.default || e.forceNativeWebSocket);
			if (i.port != null && (s.port = Number(i.port)), s.host = i.hostname, s.query = i.query, s.auth = i.auth, s.protocol = i.protocol, s.path = i.path, e = {
				...s,
				...e
			}, !e.protocol && !o) throw new Error("Missing protocol");
...
var Xl = j((ge) => {
	...
	ge.UniqueMessageIdProvider = Ai(Lg()).default;
...
var mqtt_esm_default = j((ot) => {
	...
	var zb = ot && ot.__createBinding || (Object.create ? (function(t, e, r, n) {
		...
		t.default = e;
	}), YT = ot && ot.__importStar || (function() {
		var t = function(e) {
			return t = Object.getOwnPropertyNames || function(r) {
				var n = [];
				for (var i in r) Object.prototype.hasOwnProperty.call(r, i) && (n[n.length] = i);
